<template>
  <div class="home">
    <div class="promo-slider">
      <img src="../assets/img/avecover-min.jpg" class="img-responsive">
    ...
    <section id="look-section">
      <div class="look-section-container">
        <div>
...
#popular {
  display: grid;
  // grid-template-rows: repeat(3, minmax(1fr, 5fr)) ;
  grid-row: auto;
